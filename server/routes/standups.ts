  ...
  try {
    const standup = await prisma.standup.create({
      data: {
        ...
        transcript: [
          { speaker: 'Muddy', text: 'Good morning team. Let\'s run through status updates.' },
          ...
          { speaker: 'Warren', text: 'Revenue pipeline healthy. TechCorp proposal in review.' },
          { speaker: 'Muddy', text: 'Solid updates. Action items compiled. Reconvene tomorrow.' },
        ],
        actionItems: [
          { text: 'Ship cost breakdown view', assignee: 'Elon', done: false },
          { text: 'Complete TechCorp case study', assignee: 'Gary', done: false },
          { text: 'Close TechCorp deal', assignee: 'Warren', done: false },
        ],
        status: 'completed',
