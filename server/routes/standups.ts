    ...
    const standup = await prisma.standup.create({
      data: {
        ...
        transcript: [
          ...
          { speaker: 'Steve Jobs', text: 'Newsletter open rate hit 34%. Community growing well.' },
          { speaker: 'Marc Benioff', text: 'Revenue pipeline healthy. TechCorp proposal in review.' },
        ...
        actionItems: [
          ...
          { text: 'Close TechCorp deal', assignee: 'Marc Benioff', done: false },
        ],
        status: 'completed',
