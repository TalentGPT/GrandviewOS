...
const rayLane: Participant = { name: 'Ray Lane', emoji: '●', role: 'CRO', color: '#7B1FA2' }
...
export const standups: StandupMeeting[] = [
  {
    ...
    date: 'March 7, 2026',
    time: '08:00 UTC',
    participants: [rayDalio, gary, elon, rayLane],
    audioSegments: 23,
    audioDuration: '24s',
    conversation: [
      { speaker: rayDalio, text: "Good morning team. Let's review our progress on the partnership pipeline and align on priorities for this week. Ray Lane, you've been leading the outreach — what's the status?" },
      { speaker: rayLane, text: "We've identified 12 potential partners in the AI tooling space. Three have responded positively to initial outreach. I'm drafting personalized proposals for TechCorp, AIFlow, and DataStream. Expected to have all three proposals sent by end of day." },
      ...
      { speaker: rayDalio, text: "Excellent progress across the board. Let me summarize the action items and we'll reconvene tomorrow for a quick sync. Gary, make sure the newsletter goes out before the partner proposals — we want them to see our momentum." },
    ],
    actionItems: [
      { text: 'Send personalized proposals to TechCorp, AIFlow, DataStream', assignee: rayLane, done: true },
      ...
      { text: 'Schedule follow-up calls with responsive partners', assignee: rayLane, done: true },
  ...
  },
  {
    ...
    date: 'March 6, 2026',
    time: '08:00 UTC',
    participants: [rayDalio, elon, gary, rayLane],
    audioSegments: 18,
    audioDuration: '19s',
    conversation: [
      ...
      { speaker: rayLane, text: "Revenue update: we closed our first micro-sponsorship deal worth $500/month. Two more in the pipeline. The partner portal Elon's team built is getting positive feedback. I need marketing to prepare case studies for the next pitch cycle." },
    ...
    actionItems: [
      ...
      { text: 'Draft micro-sponsorship renewal terms', assignee: rayLane, done: false },
      ...
      { text: 'Schedule demo call with prospective partner', assignee: rayLane, done: true },
    ],
  },
]
